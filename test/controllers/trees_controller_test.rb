...
class TreesControllerTest < ActionController::TestCase
  ...
  test "should create tree" do
    assert_difference('Tree.count') do
      post :create, tree: { age: @tree.age, amount-of-rings: @tree.amount-of-rings, family: @tree.family, leaf-shape: @tree.leaf-shape }
    end
  ...
  test "should update tree" do
    patch :update, id: @tree, tree: { age: @tree.age, amount-of-rings: @tree.amount-of-rings, family: @tree.family, leaf-shape: @tree.leaf-shape }
    assert_redirected_to tree_path(assigns(:tree))
  end
